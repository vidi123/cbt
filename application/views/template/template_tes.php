...
<html>
  <head>
	...
	<meta name="description" content="Aplikasi Ujian Online CBT SMKN 46">
	<meta name="keywords" content="Aplikasi Ujian Online CBT SMKN 46">
	<meta name="author" content="CBT SMKN 46">
    <!-- Bootstrap 3.3.4 -->
  ...
  <!--Favicon-->
  <link rel="icon" href="<?php echo base_url(); ?>public/favicon.ico" type="image/png">
  </head>
  <!-- ADD THE CLASS layout-top-nav TO REMOVE THE SIDEBAR. -->
  <body class="skin-green layout-top-nav" id="body-all">
    <div class="wrapper">
      ...
      <footer class="main-footer no-print">
        ...
        <div class="container">
          <strong>&copy; SMKN 46 JAKARTA</strong>
        </div><!-- /.container -->
      </footer>
    </div><!-- ./wrapper -->
  ...
  <script type="text/javascript">
    $(function () {
        ...
        //     window.location.href = "https://cbt.ypp-tunasharapan.sch.id/welcome/logout"    
        // });
