<div class="container container-tes">
    ...
    <div class="modal" id="warningStartTest" style="max-height: 100%;overflow-y: auto;" id="modal-hentikan" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div id="trx-judul">Konfirmasi Memulai Tes</div>
                </div>
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="callout callout-info">
                                <p>Apakah anda yakin memulai ujian mata uji ini ?
                            </div>
                        </div>
                        <div class="alert alert-danger" role="alert">
                          Dilarang keluar dari mode <strong>fullscreen</strong>! <br/> Ujian akan mengulang jika keluar dari mode fullscreen! 
                        </div>
                    </div>
                </div>
				<div class="box-footer">
					<button type="submit" class="btn btn-success button-fullscreen">Ya, Mulai Sekarang</button>
				</div>
            </div>
        </div>
    </div>
    
    <!--<div class="modal" id="warningResumeTest" style="max-height: 100%;overflow-y: auto;" id="modal-hentikan" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">-->
    <!--    <div class="modal-dialog">-->
    <!--        <div class="modal-content">-->
    <!--            <div class="modal-header">-->
    <!--                <div id="trx-judul">Konfirmasi Melanjutkan Tes ?</div>-->
    <!--            </div>-->
				<!--<div class="box-footer">-->
				<!--	<button type="submit" class="btn btn-success button-fullscreen-resume">Ya, Lanjutkan Sekarang</button>-->
				<!--</div>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--</div>-->
    ...
    $(function () {
        ...
        $( document ).ready(function() {
            ...
            $(window).on('load', function() {
                $('#warningStartTest').modal('show');
            });
            
             var elem = document.getElementById("body-all");
             var buttonFullscreen = document.querySelector(".button-fullscreen");
            //  var buttonFullscreenResume = document.querySelector(".button-fullscreen-resume");
            ...
            buttonFullscreen.addEventListener("click", e => {
                openFullscreen();
                $('#warningStartTest').modal('hide');
            })
            
            // buttonFullscreenResume.addEventListener("click", e => {
            //     openFullscreen();
            //     $('#warningResumeTest').modal('hide');
            // })
            ...
            function hapus_tes(){
                $.getJSON('<?php echo site_url().'/'.$url; ?>/hapus_tes/'+ $('#tes-user-id').val(), function(data){
                    window.location.href = "https://cbtguruhebat.my.id/welcome/logout"
                })
