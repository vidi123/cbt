...
<section class="content">
	<div class="row">
        <div class="col-md-3">
                <!-- <?php echo form_open($url.'/hapusmodul','id="form-hapus-modul"'); ?> -->
                <div class="box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="box-tools pull-right">
    							<div class="dropdown pull-right">
    								<a style="cursor: pointer;" onclick="tambahModul()">Tambah Modul</a>
    							</div>
    					    </div>
                            <div id="data-kelas">
                                <select name="modul" id="modul" name="modul" class="form-control input-sm">
                    ...
                    <button type="submit" id="btn-hapus-modul" class="btn btn-primary" style="margin-left: 10px; margin-bottom: 10px;">Hapus</button>
                </div>
                <!-- </form> -->
        </div>
    ...
    <!-- tambah modul -->
    <div class="modal" id="modal-tambah-modul" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
    <?php echo form_open($url.'/tambahmodul','id="form-tambah-modul"'); ?>
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tambah-modul-modul" name="tambah-modul-modul" placeholder="Nama Modul">
                            </div>

                            <div class="form-group hidden">
                                <input type="text" class="form-control" id="tambah-modul-aktif" name="tambah-modul-aktif" value="1" readonly>
                            </div>
                            <span>NB : Pastikan nama modul belum pernah terdaftar</span>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" id="tambah-modul-simpan" class="btn btn-primary">Tambah Modul</button>
    ...
    <!-- hapus modul -->
    <div class="modal" id="modal-hapus-modul" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button class="close" type="button" data-dismiss="modal">&times;</button>
                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            <strong>Peringatan</strong>
                            Modul yang sudah dipilih akan dihapus beserta data topik dan soal didalamnya.
                            <br /><br />
                ...
                <div class="modal-footer">
                    <?php echo form_open($url.'/hapusmodul','id="form-hapus-modul"'); ?>
                        ...
                        <br>
                        <p>* Silahkan pilih modul yang ingin dihapus</p>
                        <br>
                        <br>
                        <button type="submit" id="btn-hapus" class="btn btn-default pull-left">Hapus</button>
                        <a href="#" class="btn btn-primary" data-dismiss="modal">Close</a>
                    </form>
                </div>
            </div>
...
<script lang="javascript">
    ...
    $(function(){
        ...
        // hapus modul
        $('#btn-hapus-modul').click(function(){
            $("#modal-hapus-modul").modal('show');
        });
        // hapus modul
        ...
        // tambah modul
        $('#form-tambah-modul').submit(function(){
            $("#modal-proses").modal('show');
            $.ajax({
                    url:"<?php echo site_url().'/'.$url; ?>/tambahmodul",
                    type:"POST",
                    data:$('#form-tambah-modul').serialize(),
                    cache: false,
                    success:function(respon){
                        var obj = $.parseJSON(respon);
                        if(obj.status==1){
