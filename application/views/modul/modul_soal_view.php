                    ...
                    <?php echo form_open_multipart($url.'/tambah','id="form-tambah" class="form-horizontal"'); ?>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-2 control-label">Poin Soal</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control input-sm" name="soal_poin" id="soal-poin" >
                                    <p class="help-block">Angka desimal menggunakan pemisah titik(.) .Contoh: 1 , 2.5 , 3.5 , 4</p>
                                </div>
                            </div>
                            <div class="form-group">
		...
		$( document ).ready(function() {
            ...
            $('#table-soal').DataTable({
                  ...
                  "aoColumns": [
                        ...
                        {"bSearchable": false, "bSortable": false, "sWidth":"50px"},{"bSearchable": false, "bSortable": false, "sWidth":"50px"}],
